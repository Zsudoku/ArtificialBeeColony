...
void init_json(){
	...
	sm[0] = {-1,0,"3号堆垛机","运行",0,0,0,0,10000,10000,37.49,0,0,0,0,0,0,10000,10000,37.49,0,0,0,0,0,0,10000,10000,37.49,0,0,0,0,10000,10000,37.49,0,0,0,'0'};
	sm[1] = {-1,0,"4号堆垛机","运行",0,0,0,0,10000,10000,41.27,0,0,0,0,0,0,10000,10000,41.27,0,0,0,0,0,0,10000,10000,41.27,0,0,0,0,10000,10000,41.27,0,0,0,'0'};
	sm[2] = {-1,0,"5号堆垛机","运行",0,0,0,0,10000,10000,44.04,0,0,0,0,0,0,10000,10000,44.04,0,0,0,0,0,0,10000,10000,44.04,0,0,0,0,10000,10000,44.04,0,0,0,'0'};
	sm[3] = {-1,0,"6号堆垛机","运行",0,0,0,0,10000,10000,46.74,0,0,0,0,0,0,10000,10000,46.74,0,0,0,0,0,0,10000,10000,46.74,0,0,0,0,10000,10000,46.74,0,0,0,'0'};
	sm[4] = {-1,0,"7号堆垛机","运行",0,0,0,0,10000,10000,49.48,0,0,0,0,0,0,10000,10000,49.48,0,0,0,0,0,0,10000,10000,49.48,0,0,0,0,10000,10000,49.48,0,0,0,'0'};
	sm[5] = {-1,0,"8号堆垛机","运行",0,0,0,0,10000,10000,52.38,0,0,0,0,0,0,10000,10000,52.38,0,0,0,0,0,0,10000,10000,52.38,0,0,0,0,10000,10000,52.38,0,0,0,'0'};
}
